package com.baiyi.gulimall.product.execption;

import com.baiyi.gulimall.common.exception.BizCodeEnum;
 ...
 */
@Slf4j
@RestControllerAdvice(basePackages = {"com.baiyi.gulimall.product.controller"})
